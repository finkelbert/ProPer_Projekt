...
main_df <- mutate(group_by(main_df,file),
                  ...
                  per_thresh_indeed = ifelse(rel_to=="stim", max_stim_per_power * per_floor, ifelse(rel_to=="data", max_data_per_power * per_floor, max_speaker_per_power * per_floor)),
                  ## strengthresh threshold settings
                  max_stim_strength = max(strength_rowmax, na.rm=T),
                  strengthresh_indeed = ifelse(rel_to=="stim", max_stim_strength * strengthresh, ifelse(rel_to=="data", max_data_strength * strengthresh, max_speaker_strength * strengthresh)),
                  ...
                  ## get f0 extremas  
                  f0_stim_max = max(f0_smooth_interp, na.rm=T),
                  f0_stim_min = min(f0_smooth_interp, na.rm=T),
