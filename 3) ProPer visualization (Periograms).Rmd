...
########## F0 interpolating and smoothing
##  f0_smooth_stretch
    f0_smootch = ifelse(
...
# ##  f0_smooth_stretch_interp_smooth_drop outer stretch
  f0_smootcherpooth_dropStr = ifelse(
...
#   is.na(f0_smooth) | smogPP_20Hz < 0.25, NA, f0_smootcherpooth)
  )
...
mini_main_df <- droplevels(subset(main_df, select = -c(intensity, f0_raw, periodicStrength, totalPower, periodicPower, max_data_per_power, max_data_strength, max_speaker_per_power, max_speaker_strength, max_token_per_power, max_token_strength, perFloor_indeed, periodicFraction, postPP, logPP, f0_smootch, f0_smootcherp)))
