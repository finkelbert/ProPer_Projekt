...
## boundaries
  geom_vline(aes(xintercept=main_df$seg_start), linetype="dotted", color="white", size=.5, alpha=.5) +
  geom_vline(aes(xintercept=max(main_df$seg_end,na.rm = T)), linetype="dotted", color="white", size=.5, alpha=.5) +
## annotations
  geom_text(aes(x=main_df$seg_mid, y=f0_stim_max+10, label=as.character(label), check_overlap=T), color="white", size=2, family= "Helvetica") +
## plot stuff
...
## boundaries
  geom_vline(aes(xintercept=single_stim$seg_start), linetype="dotted", color="white", size=.5, alpha=.5) +
  geom_vline(aes(xintercept=max(single_stim$seg_end,na.rm = T)), linetype="dotted", color="white", size=.5, alpha=.5) +
## annotations
  geom_text(aes(x=single_stim$seg_mid, y=f0_stim_max+10, label=as.character(label), check_overlap=T), size=4, color="white", family= "Helvetica") + 
## plot stuff
