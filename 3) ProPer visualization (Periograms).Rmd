...
## boundaries
  geom_vline(aes(xintercept=main_df$seg_bounds), linetype="dotted", color="white", size=.5, alpha=.5) +
## annotations
...
## boundaries
  geom_vline(aes(xintercept=single_stim$seg_bounds), linetype="dotted", color="white", size=.5, alpha=.5) +
## annotations
