...
## annotations
  geom_text(aes(x=main_df$interval_mid, y=f0_stim_max+10, label=as.character(label), check_overlap=T), color="white", size=2, family= "Avenir") +
## plot stuff
...
## annotations
  geom_text(aes(x=single_stim$interval_mid, y=f0_stim_max+10, label=as.character(label), check_overlap=T), size=4, color="white", family= "Avenir") + 
## plot stuff
