...
ySclae1 <- c('tokenScale', 'speakerScale', 'dataScale')[1]
...
plotFloor1 <- ifelse(ySclae1 == 'tokenScale', single_token1$plotFloorToken[1],
                     ifelse(ySclae1 == 'speakerScale', single_token1$plotFloorSpeaker[1],
                            ifelse(ySclae1 == 'dataScale', single_token1$plotFloorData[1], -275)))
plotUnits1 <- ifelse(ySclae1 == 'tokenScale', round(single_token1$f0_token_range[1]/30),
                     ifelse(ySclae1 == 'speakerScale', round(single_token1$f0_speaker_range[1]/30),
                            ifelse(ySclae1 == 'dataScale', round(single_token1$f0_data_range[1]/30), 12)))
f0range1 <- ifelse(ySclae1 == 'tokenScale', single_token1$f0_token_range[1],
                     ifelse(ySclae1 == 'speakerScale', single_token1$f0_speaker_range[1],
                            ifelse(ySclae1 == 'dataScale', single_token1$f0_data_range[1], 350)))
f0max1 <- ifelse(ySclae1 == 'tokenScale', single_token1$f0_token_max[1],
                     ifelse(ySclae1 == 'speakerScale', single_token1$f0_speaker_max[1],
                            ifelse(ySclae1 == 'dataScale', single_token1$f0_data_max[1], 425)))
...
##--save?
ggsave(periogram_single1,file=paste0("plots/",sel_file1,"_perTest(",perFloor,")_",ySclae1,".pdf"),device=cairo_pdf)
...
### chosse the f0 scale for the y-axis in the plots
ySclae2 <- c('tokenScale', 'speakerScale', 'dataScale')[1]
...
plotFloor2 <- ifelse(ySclae2 == 'tokenScale', single_token2$plotFloorToken[1],
                     ifelse(ySclae2 == 'speakerScale', single_token2$plotFloorSpeaker[1],
                            ifelse(ySclae2 == 'dataScale', single_token2$plotFloorData[1], -275)))
plotUnits2 <- ifelse(ySclae2 == 'tokenScale', round(single_token2$f0_token_range[1]/30),
                     ifelse(ySclae2 == 'speakerScale', round(single_token2$f0_speaker_range[1]/30),
                            ifelse(ySclae2 == 'dataScale', round(single_token2$f0_data_range[1]/30), 12)))
f0range2 <- ifelse(ySclae2 == 'tokenScale', single_token2$f0_token_range[1],
                     ifelse(ySclae2 == 'speakerScale', single_token2$f0_speaker_range[1],
                            ifelse(ySclae2 == 'dataScale', single_token2$f0_data_range[1], 350)))
f0max2 <- ifelse(ySclae2 == 'tokenScale', single_token2$f0_token_max[1],
                     ifelse(ySclae2 == 'speakerScale', single_token2$f0_speaker_max[1],
                            ifelse(ySclae2 == 'dataScale', single_token2$f0_data_max[1], 425)))
...
##--save?
ggsave(periogram_single2,file=paste0("plots/",sel_file2,"_PERIOGRAM(",single_token2$perFloorStatus[1],")_",ySclae2,".pdf"),device=cairo_pdf)
