...
pitchObject_df <- plyr::ldply(files_pitchObject, function(f){  
  ...
  #### row1 = Praat's path finder choice for F0 candidates ("strength_row1" is an altrnative to "strength_rowmax")
  ...
  data.frame(file, t=as.integer(as.character(time)), strength_rowmax=round(strength_rowmax,7))
})
```
