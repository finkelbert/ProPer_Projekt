...
#### boundaries
  ...
  geom_segment(aes(x=CoM_corr, xend=CoM_corr, y=110, yend=PERatCoM*f0_stim_min), position = "dodge", color="red", size=.3, alpha=.8, linetype = "longdash", lineend = "round") + 
  geom_segment(aes(x=CoM_corr, xend=CoM_corr, y=110, yend=f0_stim_min), position = "dodge", color="green", size=.3, alpha=1, linetype = "dotted", lineend = "round") + 
...
#### annotations
  ...
  geom_text(aes(x=min(single_stim$bound,single_stim$interval_bounds,na.rm = T)-5, y=100, label="Scaling (difference in Hz):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=100, label=round(scaling)), check_overlap=T, color="black", size=3, family= "Helvetica") + 
  geom_text(aes(x=min(single_stim$bound,single_stim$interval_bounds,na.rm = T)-5, y=80, label="Synchrony (distance in ms):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=80, label=round(synchrony)), check_overlap=T, color="black", size=3, family= "Helvetica") +
  geom_text(aes(x=min(single_stim$bound,single_stim$interval_bounds,na.rm = T)-5, y=60, label="Mass (relative AUC):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=60, label=AUC_rel), check_overlap=T, color="black", size=3, family= "Helvetica") +
