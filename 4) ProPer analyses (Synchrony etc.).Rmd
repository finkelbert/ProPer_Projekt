...
##### Derivatives
  geom_line(aes(y=smogPP_1stDer*2),color="black", alpha=.4, size=1) +
  geom_line(aes(y=smogPP_2ndDer*2),color="gold", alpha=.8, size=1) +
  geom_line(aes(y=smogPP_2ndDerDyn*2),color="green", alpha=.6, size=1) +
##### annotations
...
####################### F0 curves
  ...
  ##### interpolated
  # geom_point(aes(y=f0_smerp),color="red", alpha=.3, size=.3) +
  # geom_point(aes(y=f0_smoorp),color="grey", alpha=0.3, size=.3) +
  ##### periogram (smogPP)
  geom_line(aes(y=f0_smoorp),color="blue", alpha=single_token$smogPP_20Hz, size=single_token$smogPP_20Hz*3.5) +
####################### Periodic energy curve
  geom_line(aes(y=smogPP_20Hz*f0range+plotFloor),color="red", alpha=.75, size=.5) +
####################### Speech-rate curve
  geom_line(aes(y=dynaSpeechRate*f0range+plotFloor),color="springgreen4", alpha=.75, size=2.5, linetype="solid", linejoin = "round")+#, lineend = "butt", linejoin = "round") +
####################### boundaries
...
####################### annotations
  ...
  ##### ∆F0 / F0 @ CoM
  geom_text(aes(x=CoM_corr, y=f0atCoM+plotUnits*4, label=DeltaF0Label), check_overlap=T, color="blue", size=1.5, family= "Helvetica") + 
#  
  geom_text(aes(x=CoM_corr, y=f0atCoM+plotUnits*6, label=DeltaF0_meanF0Label), check_overlap=T, color="brown", size=1.5, family= "Helvetica") + 
#  
  ##### Synchrony
  geom_text(aes(x=CoM_corr + (round(synchrony)/2), y=f0atCoG-plotUnits*4, label=syncLabel), check_overlap=T, color="darkorchid", size=1.5, family= "Helvetica") +
  ##### Mass
  geom_text(aes(x=single_token$CoM, y=plotFloor-plotUnits, label=mass_rel), check_overlap=T, color="red", size=1.5, family= "Helvetica") +
####################### legend
  ##### CoGs
