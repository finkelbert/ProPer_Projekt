...
CoG <- function(df) {
  ...
  f0Floor <- min(df$f0_interp_stretch_smooth, na.rm=T) - .1 * df$f0_speaker_range 
  ifelse(
    sum(df$smogPP_20Hz, na.rm=T) < 5, 0, # minimum = 50 (ms) * 0.1 (smogPP) = 5
...
mini_comp_df <- droplevels(comp_df[c("file", "t", "speaker", 
                          ...
                          "mass", "intervalDuration", "CoM", "CoG", "f0atCoM", "f0atCoG", "PERatCoM", "PERatCoG", "synchrony", "CoM_corr", "CoG_corr", "DeltaF0_rel", "sync_rel", "mass_rel", "intervalDuration_rel", "DeltaF0Label", "syncLabel", "localSpeechRate")])
