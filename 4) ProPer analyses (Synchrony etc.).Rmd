...
## adjust the maximum allowed distance (in ms) between boundaries that are automatically detected (periodic energy minima) and manually segmented (TextGrid annotation)
autoMan <- 40 
...
# 
expSyllNum <- length(which(!is.na(single_token$syll_bounds)))
#
## == ## == ## == ## == ## == ## == ## == ## == ## == ## == ##
## == ## == ## == ## == ## == ## == ## == ## == ## == ## == ##
#
...
##
mkBoundetect <- function(single_token) {
...
####################### boundaries
  geom_segment(aes(x=syll_bounds, xend=syll_bounds, y=plotFloor, yend=f0_token_max+plotUnits*9), linetype="dotted", color="black", size=.5, alpha=.7) +
...
####################### annotations
  ##### text
  geom_text(aes(x=single_token$syll_mid, y=f0_token_max+plotUnits*8, label=syll_label, check_overlap=T), color="black", size=3, family= "Helvetica") +
  ##### ∆F0 / F0 @ CoM
...
mini_comp_df <- comp_df[c("file", "t", "speaker", "syll_mid", "syll_bounds", "syll_label", "word_mid", "word_bounds", "word_label", "f0_speaker_min", "f0_speaker_max", "f0_speaker_median", "f0_speaker_mean", "f0_speaker_range", "f0_token_min", "f0_token_max", "f0_token_median", "f0_token_mean", "f0_token_range", "smogPP_20Hz", "smogPP_12Hz", "smogPP_8Hz", "smogPP_5Hz", "f0_interp_stretch_smooth", "f0_interp_smooth", "syll_boundsSeq", "auto_bounds", "DeltaF0", "auto_boundsSeq", "mass", "intervalDuration", "CoM", "CoG", "f0atCoM", "PERatCoM", "f0atCoG", "PERatCoM", "PERatCoG", "synchrony", "CoM_corr", "CoG_corr", "DeltaF0_rel", "sync_rel", "mass_rel", "intervalDuration_rel", "DeltaF0Label", "syncLabel", "CoM_seq", "localSpeechRate")]
