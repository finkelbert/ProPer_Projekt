...
detection_sensitivity <- 8  # choose values from 5 to 20 (low-pass smooth in Hz), 
...
if(detetor_type == "auto") boundetect <- which(
     ...
     ## eliminate elbows:
     lead(comp_df$smog_pp_1st_der,30) > 0 &
     ## (continue)
...
detect_sel_file <- files[2] # or: "filename" 
