...
#### annotations
  ...
  geom_text(aes(x=min(single_stim$per_fluct_bound,single_stim$interval_bounds,na.rm = T)-5, y=50, label="Scaling (difference in Hz):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=50, label=round(scaling)), check_overlap=T, color="black", size=3, family= "Helvetica") + 
  geom_text(aes(x=min(single_stim$per_fluct_bound,single_stim$interval_bounds,na.rm = T)-5, y=30, label="Synchrony (distance in ms):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=30, label=round(synchrony)), check_overlap=T, color="black", size=3, family= "Helvetica") +
  geom_text(aes(x=min(single_stim$per_fluct_bound,single_stim$interval_bounds,na.rm = T)-5, y=10, label="Mass (relative AUC):"), check_overlap=T, color="black", size=3, family= "Helvetica", hjust="right") + 
  geom_text(aes(x=single_stim$CoM, y=10, label=AUC_rel), check_overlap=T, color="black", size=3, family= "Helvetica") +
...
#### legendary
  ...
  geom_text(aes(x=min(single_stim$per_fluct_bound,single_stim$interval_bounds,na.rm = T)-20, y=75), label="CoM", color="red", alpha=1, size=3, family = "Helvetica", check_overlap=T, na.rm = T, hjust="right") +
  ...
  geom_text(aes(x=min(single_stim$per_fluct_bound,single_stim$interval_bounds,na.rm = T)-20, y=100), label="CoG", color="blue", alpha=1, size=3, family = "Helvetica", check_overlap=T, na.rm = T, hjust="right") +
#### plot stuff
